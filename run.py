...
navbar = dbc.NavbarSimple(
    brand='Stackoverflow Question Quality Classifier',
    brand_href='/', 
    children=[
        dbc.NavItem(dcc.Link('Predictions', href='/predictions', className='nav-link')), 
        # dbc.NavItem(dcc.Link('Process', href='/process', className='nav-link')), 
        dbc.NavItem(dcc.Link('About', href='/about', className='nav-link')),
        dbc.NavItem(dcc.Link('Jupyter Notebook', href="https://github.com/ashleyadrias/stackoverflow-question-quality/blob/master/notebooks/stackoverflow_quality.ipynb", className='nav-link', target="_blank")),
